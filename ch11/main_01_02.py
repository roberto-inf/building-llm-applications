...
if __name__ == "__main__":
    chat_loop()
    # Visualize the LangGraph graph as a PNG using Mermaid.ink
    try:
        png_bytes = travel_info_agent.get_graph().draw_mermaid_png()
        with open("travel_info_agent_graph_mermaid.png", "wb") as f:
            f.write(png_bytes)
        print("Graph visualization saved as 'travel_info_agent_graph_mermaid.png'.")
    except Exception as e:
        print(f"Could not save Mermaid graph visualization: {e}") 